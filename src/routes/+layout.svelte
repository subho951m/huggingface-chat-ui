...
<ExpandNavigation
	...
	classNames="absolute inset-y-0 z-10 my-auto {!isNavCollapsed
		? 'left-[295px]'
		: 'left-[75px]'} *:transition-transform"
/>

<div
	class="grid h-full w-screen grid-cols-1 grid-rows-[auto,1fr] overflow-hidden border-8 border-indigo-600 text-smd {!isNavCollapsed
